...
import { CallParams, GatherTracesResult, MineBlockResult, TransactionParams } from "../node-types";
...
export declare class ModulesLogger {
    ...
    logSingleTransaction(tx: Transaction, block: Block, txGasUsed: number, txTrace: GatherTracesResult, code: Buffer): void;
    logCurrentlySentTransaction(tx: Transaction, txGasUsed: number, txTrace: GatherTracesResult, code: Buffer, block: Block): void;
    logEstimateGasTrace(txParams: TransactionParams, code: Buffer, trace: MessageTrace | undefined, consoleLogMessages: string[], error: Error): void;
    ...
    logMinedBlockNumber(blockNumber: number, isEmpty: boolean): void;
     ...
     */
    printLogs(): boolean;
    printMinedBlockNumber(blockNumber: number, isEmpty: boolean): void;

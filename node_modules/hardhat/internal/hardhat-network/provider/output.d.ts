...
export declare function getRpcBlock(block: Block, totalDifficulty: BN, includeTransactions?: boolean, pending?: boolean): RpcBlockOutput;
export declare function getRpcTransaction(tx: Transaction, block: Block, index: number): RpcTransactionOutput;
export declare function getRpcTransaction(tx: Transaction, block: "pending"): RpcTransactionOutput;

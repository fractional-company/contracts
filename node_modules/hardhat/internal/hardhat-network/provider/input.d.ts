...
export declare function validateParams(params: any[], block: typeof blockTag): [BlockTag];
export declare function validateParams(params: any[], block: typeof blockTag, index: typeof rpcQuantity): [BlockTag, BN];
...
export declare function validateParams(params: any[], boolean: typeof t.boolean): [boolean];
export declare function validateParams(params: any[], miningConfig: typeof rpcIntervalMining): [RpcIntervalMining];

...
function getRpcBlock(block, totalDifficulty, includeTransactions = true, pending = false) {
    ...
    return {
        number: pending ? null : numberToRpcQuantity(new ethereumjs_util_1.BN(block.header.number)),
...
function getRpcTransaction(tx, block, index) {
    return {

...
exports.validateParams = exports.rpcIntervalMining = exports.optionalRpcHardhatNetworkConfig = exports.rpcHardhatNetworkConfig = exports.rpcForkConfig = exports.rpcCompilerOutput = exports.rpcCompilerInput = exports.rpcSubscribeRequest = exports.optionalRpcFilterRequest = exports.rpcFilterRequest = exports.rpcCallRequest = exports.rpcTransactionRequest = exports.optionalBlockTag = exports.blockTag = exports.blockTagObject = exports.logTopics = exports.logAddress = exports.rpcAddress = exports.rpcUnknown = exports.rpcHash = exports.rpcData = exports.rpcQuantity = void 0;
...
const rpcUnsignedInteger = new t.Type("Unsigned integer", isInteger, (u, c) => (isInteger(u) && u >= 0 ? t.success(u) : t.failure(u, c)), t.identity);
